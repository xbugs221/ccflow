/**
 * TaskMaster shared state container.
 * Synchronizes TaskMaster project/task metadata with authenticated API calls and WebSocket events.
 */
import React, { createContext, useContext, useEffect, useState, useCallback, useRef } from 'react';
import { api } from '../utils/api';
import { useAuth } from './AuthContext';
import { useWebSocket } from './WebSocketContext';
import { getMessageHistoryTailSequence, getPendingSocketMessages } from '../../shared/socket-message-utils.js';
...
export const TaskMasterProvider = ({ children }) => {
  ...
  /**
   * Skip historical socket replay when the provider remounts.
   */
  ...
  // Handle WebSocket TaskMaster updates in sequence so bursts of socket events are not dropped.
  useEffect(() => {
    ...
    pendingMessages.forEach((entry) => {
      ...
      const latestMessage = entry.message;
  ...
  }, [messageHistory, refreshProjects, refreshTasks, refreshMCPStatus, currentProject]);
