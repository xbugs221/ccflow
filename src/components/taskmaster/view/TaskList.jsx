...
import { filterAndSortTasks, getSortedTaskFilterValues } from '../utils/taskListTransforms';
...
const TaskList = ({ 
  ...
  const statuses = useMemo(() => {
    return getSortedTaskFilterValues(tasks, 'status');
  }, [tasks]);

  const priorities = useMemo(() => {
    return getSortedTaskFilterValues(tasks, 'priority');
  }, [tasks]);
          ...
          <div className="fixed inset-0 z-50 flex items-start justify-center p-4 pt-16 bg-black/50 backdrop-blur-sm">
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 w-full max-w-4xl h-[600px] flex flex-col">
              ...
              <div className="flex-1 p-4">
                <div 
                  className="h-full rounded-lg bg-white overflow-hidden dark:bg-gray-900" 
                  onClick={(e) => {
                ...
                >
                  <Shell 
                    ...
                    isActive={true}
                    initialCommand="pnpm dlx task-master-ai init"
                    isPlainShell={true}
