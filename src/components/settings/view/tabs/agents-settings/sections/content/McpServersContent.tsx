// PURPOSE: Render Codex MCP server settings and actions.
import { Edit3, Plus, Server, Terminal, Trash2 } from 'lucide-react';
...
export default function McpServersContent({ servers, onAdd, onEdit, onDelete, deleteError }: McpServersContentProps) {
