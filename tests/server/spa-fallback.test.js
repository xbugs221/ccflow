...
import { shouldServeSpaIndex } from '../../server/utils/spaFallback.js';

function request(path, accept = 'text/html,application/xhtml+xml') {
  /**
...
test('serves workflow route when run id contains timestamp dots', () => {
  /**
   * wo run ids use RFC3339-like timestamps such as 20260508T165749.722Z; direct
