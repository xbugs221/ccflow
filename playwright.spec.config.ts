...
export default {
  ...
  testMatch: [
    'spec/**/*.spec.ts',
    '2026-05-10-6-精简设置页和侧边栏导航-settings-sidebar-simplification.test.ts',
    '2026-05-10-7-重新设计交互布局-workspace-dock-layout.test.ts',
    '2026-05-10-8-修正dock拉伸方向和源代码管理布局漂移-workspace-dock-regression.test.ts',
    '2026-05-10-9-修复工作区滚动和dock面板控制-workspace-scroll-and-pane-controls.test.ts',
    '2026-05-10-10-修复桌面dock工作区宽度收缩-workspace-dock-width-regression.test.ts',
    '2026-05-10-12-区分移动端单视图和精简会话标题-12-main-content-title-resume-id.test.ts',
