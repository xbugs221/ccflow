...
- **当** 后端检查 oz、wo、co、Codex、Pi 等运行依赖
...
> 合并自归档提案：`2026-05-18-36-加速多Provider仓库发现和会话索引`
...
> 合并自归档提案：`2026-05-18-37-修复Pi用户消息气泡和续发回显`
...
当 Pi request 被 co daemon 认领但尚未完成时，cbw 仍应保留用户刚发送的消息。
...
> 合并自归档提案：`2026-05-18-38-优化聊天历史虚拟滚动和懒渲染`
...
> 合并自归档提案：`2026-05-18-39-修复首页加载退化和文件提及体验`
