 ...
 */
export function resolveWoProjectPath(projectPath: string): string {
 ...
 */
export function sanitizeWoRepoBasename(projectPath: string): string {
 ...
 */
export function resolveWoRepoKey(projectPath: string): string {
 ...
 */
export function resolveWoStateRoot(env: NodeJS.ProcessEnv = process.env): string {
 ...
 */
export function resolveWoRunsRoot(projectPath: string, env: NodeJS.ProcessEnv = process.env): string {
 ...
 */
export function resolveWoRunDir(projectPath: string, runId: string | number, env: NodeJS.ProcessEnv = process.env): string {
 ...
 */
export function resolveWoRunStatePath(projectPath: string, runId: string | number, env: NodeJS.ProcessEnv = process.env): string {
 ...
 */
export function resolveWoBatchesRoot(projectPath: string, env: NodeJS.ProcessEnv = process.env): string {
 ...
 */
export function resolveWoBatchStatePath(projectPath: string, batchId: string, env: NodeJS.ProcessEnv = process.env): string {
 ...
 */
export function formatWoStatePathForDiagnostics(statePath: string, env: NodeJS.ProcessEnv = process.env): string {
