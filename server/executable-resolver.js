 ...
 */
function getExecutableSuffixes(env = process.env, platform = process.platform) {
  /**
 ...
 */
export function resolveExecutablePath(commandName, { env = process.env, platform = process.platform } = {}) {
