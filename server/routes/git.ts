...
router.get('/diff', async (req: express.Request, res: express.Response) => {
...
router.get('/file-with-diff', async (req: express.Request, res: express.Response) => {
  const { project, file, projectPath } = req.query;
...
router.post('/initial-commit', async (req: express.Request, res: express.Response) => {
...
router.post('/commit', async (req: express.Request, res: express.Response) => {
...
router.post('/create-branch', async (req: express.Request, res: express.Response) => {
...
router.post('/delete-branch', async (req: express.Request, res: express.Response) => {
  const { project, branch, projectPath } = req.body;
...
// Get recent commits.
router.get('/commits', async (req: express.Request, res: express.Response) => {
...
router.get('/commit-diff', async (req: express.Request, res: express.Response) => {
...
router.post('/generate-commit-message', async (req: express.Request, res: express.Response) => {
...
router.get('/remote-status', async (req: express.Request, res: express.Response) => {
  const { project, projectPath } = req.query;
...
router.post('/discard', async (req: express.Request, res: express.Response) => {
...
router.post('/delete-untracked', async (req: express.Request, res: express.Response) => {
  const { project, file, projectPath } = req.body;
